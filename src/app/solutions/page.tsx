...
export default function SolutionsPage() {
  return (
    <>
        ...
        <div className="divide-y divide-line">
          ...
          <article className="py-10">
            ...
            <p className="mt-3 max-w-3xl leading-relaxed text-graphite">
              ...
              and Microsoft 365. This is where we go deepest — the full
              practice has its own hub with a dedicated page per product.
            </p>
            <div className="mt-6">
              <GhostCta href="/solutions/microsoft-copilot-agents">
                Explore Copilot Agent Solutions
              </GhostCta>
            </div>
          </article>
        </div>
      ...
      <CtaBanner heading="Have an AI problem that doesn't fit a category?" />
      <JsonLd
        data={serviceSchema({
          name: "AI Solutions for Business",
          description:
            "Custom AI agents, process automation, and AI integration services for companies of any size.",
          path: "/solutions",
        })}
      />
      <JsonLd
